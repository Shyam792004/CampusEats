...
const INITIAL_MENU_ITEMS = [
  ...
  },
  {
    ...
    price: 35,
    image: "https://images.unsplash.com/photo-1597306691227-59c87f9c7f68?w=400",
...
const CATEGORIES = [
  {
    name: "Veg",
    description: "Pure vegetarian delights made with fresh ingredients",
  },
        ...
        {CATEGORIES.map((cat, idx) => (
          <div
            ...
            style={{
              ...
              transform:
                hoveredCard === idx ? "translateY(-10px)" : "translateY(0)",
            ...
            >
              <button
                ...
                style={{
                  ...
                  border: "none",
                  backgroundColor:
                    quantity <= 1 ? (darkMode ? "#444" : "#e0e0e0") : "#007bff",
